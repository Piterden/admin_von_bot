...
Котики
Анимэ`,
      description: 'Список кноп, показываемых пользователю. Каждая кнопа с новой строки. Длина текста одной кнопы не должна превышать 25 символов. Первая кнопа является правильным вариантом. С помощью символа - или + в начале строки можно задать, кикает (-) кнопка пользователя или пропускает (+).',
    },
  },
}
